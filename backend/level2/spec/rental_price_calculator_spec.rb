...
describe RentalPriceCalculator do
  ...
  let(:twelve_days_rpc) { RentalPriceCalculator.new(twelve_days_rental, rented_car) }
  ...
  describe '#rental_price' do
    ...
    it 'given rental of 2 day and 300 km' do
      expect(two_days_rpc.rental_price).to eq(6800)
    end

    it 'given rental of 12 day and 1000 km' do
  ...
  describe '#duration_discount' do
    ...
    it 'given rental of 2 day' do
      expect(two_days_rpc.duration_discount).to eq(200)
    end

    it 'given rental of 12 day' do
